...
<div class="card">
  <div class="card-body">
    <form class="form-group" method="post" action="/admin/produk" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
        ...
        <div class="form-group row mb-2">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control form-control-plaintext @error('nama')
                                is-invalid
                            @enderror" id="nama" name="nama" placeholder="Enter Product Name" required value="{{ old('nama') }}" />
            @error('nama')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="form-group row mb-2">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control form-control-plaintext @error('harga')
                                is-invalid
                            @enderror" id="harga" name="harga" placeholder="Enter Price (Rp)" required value="{{ old('harga') }}" />
            @error('harga')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
